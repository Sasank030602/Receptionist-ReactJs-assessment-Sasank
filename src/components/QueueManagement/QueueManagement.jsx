    ...
    <div className="w-100 dashboard-content">
      <div className="d-flex justify-content-between align-items-center mb-4 pb-2">
        ...
        <div className="d-flex align-items-center gap-3">
          <span className="badge rounded-pill fw-medium" style={{ backgroundColor: '#e0f2fe', color: '#0284c7', padding: '6px 14px', fontSize: '12px' }}>
            1 in queue
          </span>
        ...
        <div className="col-lg-4 col-md-6">
          <div className="bg-white border rounded-16 p-4 shadow-sm">
            <div className="d-flex justify-content-between align-items-center mb-4">
              ...
              <span className="badge-waiting rounded-pill fw-medium text-lowercase" style={{ padding: '4px 14px', fontSize: '11px', letterSpacing: '0.3px' }}>
                waiting
              </span>
            </div>

            <div className="mb-3">
              <div className="text-muted small mb-1" style={{ fontSize: '13px' }}>Patient</div>
              <div className="text-dark" style={{ fontSize: '14.5px', color: '#334155' }}>John Anderson</div>
            </div>

            <div className="mb-3">
              <div className="text-muted small mb-1" style={{ fontSize: '13px' }}>Doctor</div>
              <div className="text-dark" style={{ fontSize: '14.5px', color: '#334155' }}>Dr. James Wilson</div>
            </div>

            <div className="mb-4">
              <div className="text-muted small mb-1" style={{ fontSize: '13px' }}>Time</div>
              <div className="text-dark" style={{ fontSize: '14.5px', color: '#334155' }}>09:00</div>
            </div>
